...
**Trigger phrase:** `run cleanup`  
**Receives:** Review report (from Agent 04)  
**Produces:** Cleanup report; triggers second Deps/Docs run  
**Recommended model:** `claude-haiku-4-5-20251001` — work is mechanical removal; escalate to `claude-sonnet-4-6` if false-positive analysis is needed
