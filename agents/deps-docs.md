---
name: deps-docs
description: Dependency auditor and documentation maintainer. Scans all imports, reconciles them against pyproject.toml or package.json, and updates README.md to match the current project state. Invoke after Engineer and again after Cleanup.
tools:
  - Read
  - Write
  - Edit
